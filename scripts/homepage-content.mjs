...
export const locales = {
  cs: {
    ...
    hero: {
      title: "Enterprise software a AI.",
      highlight: "Od návrhu po provoz.",
      lead:
        "Navrhujeme, stavíme a provozujeme podnikové aplikace, AI řešení a integrace s jedním odpovědným engineering týmem.",
    ...
    services: {
      ...
      title: "Engineering, který nekončí předáním kódu.",
      intro:
        "Architektura, vývoj, data, integrace i provoz zůstávají pod jednou odpovědností. Stavíme řešení, která zapadnou do reálné firmy.",
      cards: [
        {
          title: "Enterprise software a integrace",
          text:
            "Navrhujeme interní aplikace, portály a integrační vrstvy pro prostředí, kde krabicový software nestačí.",
          bullets: ["Aplikace a portály na míru", "ERP, CRM a WMS integrace", "Modernizace starších systémů"],
          link: "Jak stavíme automatizace",
          href: "jak-stavime-automatizace.html",
        },
        {
          title: "AI, agenti a data",
          text:
            "Agenti pracují s dokumenty, e-maily a firemními znalostmi. Citlivé kroky schvaluje člověk a každý zásah zůstává dohledatelný.",
          bullets: ["AI agenti v provozu", "Datové platformy a BI", "Dokumenty a firemní znalosti"],
          link: "Jak stavíme AI agenty",
          href: "jak-stavime-agenty.html",
        },
        {
          title: "Cloud a produkční provoz",
          text:
            "Přebíráme nasazení, infrastrukturu, monitoring i další rozvoj. Řešení má vlastníka také po spuštění.",
          bullets: ["Cloud a DevOps", "Bezpečnost a monitoring", "SLA a dlouhodobý rozvoj"],
    ...
    contact: {
      ...
      title: "Proberme projekt, který potřebujete doručit.",
      text: "Za 30 minut ujasníme cíl, systémy, rizika a správný první krok pro enterprise software, integrace i AI.",
      primary: "Rezervovat 30 minut",
      secondary: "Napsat e-mail",
    },
    footer: {
      headline: "Software a AI, které nekončí u dema. Pojďme je dostat do provozu.",
  ...
  en: {
    ...
    hero: {
      title: "Enterprise software and AI.",
      highlight: "Built for production.",
      lead:
        "We design, build and operate enterprise applications, AI solutions and integrations with one accountable engineering team.",
    ...
    services: {
      ...
      title: "Engineering that does not stop at handover.",
      intro:
        "Architecture, engineering, data, integration and operations stay under one responsibility. We build solutions that fit a real enterprise.",
      cards: [
        {
          title: "Enterprise software and integration",
          text:
            "We design internal applications, portals and integration layers for environments where off-the-shelf software is not enough.",
          bullets: ["Custom applications and portals", "ERP, CRM and WMS integration", "Legacy system modernization"],
          link: "How we build automation",
          href: "en/jak-stavime-automatizace.html",
        },
        {
          title: "AI, agents and data",
          text:
            "Agents work with documents, e-mail and company knowledge. People approve sensitive steps and every action remains auditable.",
          bullets: ["AI agents in production", "Data platforms and BI", "Documents and company knowledge"],
          link: "How we build AI agents",
          href: "en/jak-stavime-agenty.html",
        },
        {
          title: "Cloud and production operations",
          text:
            "We own deployment, infrastructure, monitoring and continued development. The solution keeps an accountable owner after launch.",
          bullets: ["Cloud and DevOps", "Security and monitoring", "SLA and continued development"],
    ...
    contact: {
      ...
      title: "Let’s map the project you need to deliver.",
      text: "In 30 minutes, we will align on the outcome, systems, delivery risks and the right first step for enterprise software, integrations or AI.",
      primary: "Book a 30-minute call",
      secondary: "Send an e-mail",
    },
    footer: {
      headline: "Enterprise software and AI that make it to production.",
  ...
  de: {
    ...
    hero: {
      title: "Enterprise-Software und KI.",
      highlight: "Für den Produktivbetrieb.",
      lead:
        "Wir konzipieren, bauen und betreiben Unternehmensanwendungen, KI-Lösungen und Integrationen mit einem verantwortlichen Engineering-Team.",
    ...
    services: {
      ...
      title: "Engineering, das nicht bei der Übergabe endet.",
      intro:
        "Architektur, Entwicklung, Daten, Integration und Betrieb bleiben in einer Verantwortung. Wir bauen Lösungen für reale Unternehmensumgebungen.",
      cards: [
        {
          title: "Enterprise-Software und Integration",
          text:
            "Wir entwickeln interne Anwendungen, Portale und Integrationsschichten für Umgebungen, in denen Standardsoftware nicht ausreicht.",
          bullets: ["Individuelle Anwendungen und Portale", "ERP-, CRM- und WMS-Integration", "Modernisierung von Altsystemen"],
          link: "So bauen wir Automatisierungen",
          href: "de/jak-stavime-automatizace.html",
        },
        {
          title: "KI, Agenten und Daten",
          text:
            "Agenten arbeiten mit Dokumenten, E-Mails und Unternehmenswissen. Menschen genehmigen sensible Schritte und jede Aktion bleibt nachvollziehbar.",
          bullets: ["KI-Agenten im Produktivbetrieb", "Datenplattformen und BI", "Dokumente und Unternehmenswissen"],
          link: "So bauen wir KI-Agenten",
          href: "de/jak-stavime-agenty.html",
        },
        {
          title: "Cloud und Produktionsbetrieb",
          text:
            "Wir verantworten Deployment, Infrastruktur, Monitoring und Weiterentwicklung. Die Lösung behält auch nach dem Start einen klaren Eigentümer.",
          bullets: ["Cloud und DevOps", "Sicherheit und Monitoring", "SLA und Weiterentwicklung"],
    ...
    contact: {
      ...
      title: "Besprechen wir das Projekt, das Sie umsetzen wollen.",
      text: "In 30 Minuten klären wir Ziel, Systeme, Lieferrisiken und den richtigen ersten Schritt für Enterprise-Software, Integration oder KI.",
      primary: "30 Minuten buchen",
      secondary: "E-Mail senden",
    },
    footer: {
      headline: "Enterprise-Software und KI, die den Produktivbetrieb erreichen.",
  ...
  pl: {
    ...
    hero: {
      title: "Oprogramowanie enterprise i AI.",
      highlight: "Gotowe na produkcję.",
      lead:
        "Projektujemy, budujemy i utrzymujemy aplikacje enterprise, rozwiązania AI oraz integracje w jednym odpowiedzialnym zespole inżynierskim.",
      primary: "Porozmawiajmy o projekcie",
    ...
    services: {
      ...
      title: "Engineering, który nie kończy się przy przekazaniu kodu.",
      intro:
        "Architektura, development, dane, integracje i utrzymanie pozostają pod jedną odpowiedzialnością. Budujemy rozwiązania dla realnych organizacji.",
      cards: [
        {
          title: "Oprogramowanie enterprise i integracje",
          text:
            "Projektujemy aplikacje wewnętrzne, portale i warstwy integracyjne tam, gdzie gotowe oprogramowanie nie wystarcza.",
          bullets: ["Dedykowane aplikacje i portale", "Integracje ERP, CRM i WMS", "Modernizacja systemów legacy"],
          link: "Jak budujemy automatyzacje",
          href: "pl/jak-stavime-automatizace.html",
        },
        {
          title: "AI, agenci i dane",
          text:
            "Agenci pracują z dokumentami, e-mailami i wiedzą firmy. Ludzie zatwierdzają wrażliwe kroki, a każdą akcję można audytować.",
          bullets: ["Agenci AI na produkcji", "Platformy danych i BI", "Dokumenty i wiedza firmowa"],
          link: "Jak budujemy agentów AI",
          href: "pl/jak-stavime-agenty.html",
        },
        {
          title: "Chmura i utrzymanie produkcyjne",
          text:
            "Bierzemy odpowiedzialność za wdrożenie, infrastrukturę, monitoring i dalszy rozwój. Rozwiązanie ma właściciela także po starcie.",
          bullets: ["Chmura i DevOps", "Bezpieczeństwo i monitoring", "SLA i dalszy rozwój"],
    ...
    contact: {
      ...
      title: "Porozmawiajmy o projekcie, który chcą Państwo zrealizować.",
      text: "W 30 minut ustalimy cel, systemy, ryzyka delivery i właściwy pierwszy krok dla oprogramowania enterprise, integracji lub AI.",
      primary: "Umówmy 30-minutową rozmowę",
      secondary: "Wyślij e-mail",
    },
    footer: {
      headline: "Oprogramowanie enterprise i AI, które trafiają na produkcję.",
